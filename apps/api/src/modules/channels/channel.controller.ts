...
export class ChannelController {
  ...
  async joinChannel(@Param('channelId') channelId: string, @Body() body: JoinChannelDto) {
    return this.channelService.joinChannel(channelId, body.userId,  body.displayName);
  }
  ...
  async joinChannelByCode(@Body() body: JoinByCodeDto) {
    ...
    return this.channelService.joinChannel(channel.id, body.userId,  body.displayName);
  }
